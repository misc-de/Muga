...
class ImageChrome(Gtk.DrawingArea):
    ...
    __gtype_name__ = "MugaImageChrome"
...
class RotatableIcon(Gtk.Image):
    ...
    __gtype_name__ = "MugaRotatableIcon"
...
class RotatableSwitch(Gtk.Switch):
    ...
    __gtype_name__ = "MugaRotatableSwitch"
...
class RotatableLabel(Gtk.Label):
    ...
    __gtype_name__ = "MugaRotatableLabel"
...
class MirroredPicture(Gtk.Picture):
    ...
    __gtype_name__ = "MugaMirroredPicture"
